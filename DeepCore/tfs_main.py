...
def main():
    ...
    parser.add_argument('--warm_epoch', default=20, type=int, help='warm up epoch')
    ...
    # use wandb
    watermark = "{}_{}".format(args.dataset, args.model)
    wandb.init(project="quat-relu", name=watermark)
    ...
    for exp in range(start_exp, args.num_exp):
        ...
        for model in models:
            ...
            n_interation  = round(len(dst_train) * args.fraction / args.train_batch) * args.epochs * (1- warm_ratio) + round(len(dst_train) / args.train_batch) * args.epochs * warm_ratio
